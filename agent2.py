...
class MyAgent(DQNAgent):
    def __init__(self, model, policy=None, test_policy=None, enable_double_dqn=False, enable_dueling_network=False,
        ...
        super(MyAgent, self).__init__(model, policy, test_policy, enable_double_dqn, enable_dueling_network,
                 dueling_type, *args, **kwargs)
    def fit(self, env, nb_steps=1, nb_episodes=709, action_repetition=1, callbacks=None, verbose=1,
